...
import { ChangeDetectorRef, Renderer2, ViewChild, ViewContainerRef } from '@angular/core';
...
@Component({
  selector: 'app-googlemapurl',
  templateUrl: './googlemapurl.component.html',
  styleUrls: ['./googlemapurl.component.scss']
})
export class GooglemapurlComponent implements OnInit {
  displayedColumns = ['sno', 'Googlemapurl','actions'];
